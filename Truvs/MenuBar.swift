...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    lazy var collectionView: UICollectionView = { //THIS IS THE PLACEHOLDER FOR ICONS IN MENU BAR
        let layout = UICollectionViewFlowLayout()
        let cv = UICollectionView(frame: .zero, collectionViewLayout: layout)
        cv.backgroundColor = UIColor.rgb(45, green: 51, blue: 120)
        cv.dataSource = self
        cv.delegate = self
        return cv
    }()
    ...
    let cellId = "cellId"
    let imageNames = ["Steve", "Bussola", "Chat", "Busca"]
...
class MenuCell: BaseCell {
    ...
    override func setupViews() {
        ...
        addConstraintsWithFormat("H:[v0(40)]", views: imageView)
        addConstraintsWithFormat("V:[v0(40)]", views: imageView)
